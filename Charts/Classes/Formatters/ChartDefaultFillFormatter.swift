...
openlass ChartDefaultFillFormatter: NSObject, ChartFillFormatter
{
    public override init()
    {
    }
    
    opopenc getFillLinePosition(dataSet: ItDataSet, dataProvider: LineChartDataProvider) -> CGFloat
    {
